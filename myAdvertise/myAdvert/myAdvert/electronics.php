    ...
    <div class="wrap">
      ...
      if(isset($_GET['action']) && isset($_SESSION['user_id'])){
         if (isset($_GET['action']) == 'delete') {
           $offerlink = "'functions.php?delete_offer=".$_GET['offer_id']."&category=electronics'";
           $offerlink2 = "'electronics.php'";
         ...
         show_offer_electronics($_GET['offer_id']);
     }
      if(isset($_GET['offer_id'])){
        ...
        if(isset($_GET['search'])) {
          show_electronics_all($_GET['search']);
        }
        elseif(!isset($_GET['search'])) {
          show_electronics_all(NULL);
        }
      } ?>
      </main>
      <script
