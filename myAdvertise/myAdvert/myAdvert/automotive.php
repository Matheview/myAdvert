      ...
      <main style="background: #ff8a65" class="infinite">
        <?php
         if(isset($_GET['action']) && isset($_SESSION['user_id'])){
            if (isset($_GET['action']) == 'delete') {
              $offerlink = "'functions.php?delete_offer=".$_GET['offer_id']."&category=automotive'";
              $offerlink2 = "'automotive.php'";
            ...
            show_offer_automotive($_GET['offer_id']);
        }
        if(isset($_GET['offer_id'])){
          ...
          if(isset($_GET['search'])) {
            show_automotive_all($_GET['search']);
          }
          elseif(!isset($_GET['search'])) {
            show_automotive_all(NULL);
          }
        }?>
      </main>
         <script
